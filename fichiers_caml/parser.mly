...
arith_exp:
   add_exp
     { $1 }
| arith_exp EQ add_exp
     { binary_exp $1 EQ $3 }
| arith_exp GE add_exp
     { binary_exp $1 GE $3 }
| arith_exp GT add_exp
     { binary_exp $1 GT $3 }
| arith_exp LE add_exp
     { binary_exp $1 LE $3 }
| arith_exp LT add_exp
     { binary_exp $1 LT $3 }
| arith_exp NE add_exp
     { binary_exp $1 NE $3 }
;
...
bool_exp:
   arith_exp
     { $1 }
| bool_exp BLAND arith_exp
     { Cond($1, $3, Bool(false)) }
| bool_exp BLOR arith_exp
     { Cond($1, Bool(true), $3) }
;
